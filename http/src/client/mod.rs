...
use crate::{
    ...
    request::{
        applications::{
            ...
            GetGlobalCommands, GetGuildCommandPermissions, GetGuildCommands,
            GetGuildCommandsPermissions, InteractionError, SetGlobalCommands, SetGuildCommands,
            SetGuildCommandsPermissions, UpdateGlobalCommand, UpdateGuildCommand,
...
use twilight_model::{
    applications::{
        command::{Command, GuildCommandPermissions},
...
impl Client {
    ...
    pub fn get_guild_commands_permissions(
        &self,
        guild_id: GuildId,
    ) -> Result<GetGuildCommandsPermissions<'_>, InteractionError> {
    ...
    pub fn update_guild_command_permissions(
        &self,
        guild_id: GuildId,
        command_id: CommandId,
    ) -> Result<UpdateGuildCommandPermissions<'_>, InteractionError> {
    ...
    pub fn set_guild_commands_permissions(
        &self,
        guild_id: GuildId,
        commands_permissions: Vec<GuildCommandPermissions>,
    ) -> Result<SetGuildCommandsPermissions<'_>, InteractionError> {
        SetGuildCommandsPermissions::new(
            &self,
            self.application_id(),
            guild_id,
